...
BUDDY_LISTING = {
    1: {'name': "Ayana Anjuman .", 'campus': "Glasgow Campus", 'photo': "ayana.jpg", 'connection': "Beauty with brains. Always the first to respond to my queries during lecture sessions (even more on Slack). Hope we get to meet in person. Perhaps, we can chat a little more about the dot."},
...
def photo_details(position):    
    ...
    photo_url = STORAGE_API_PATH + '/storage/v1/b/' + BUCKET_NAME + '/o/' + BUDDY_LISTING[position]['photo']
    ...
    photo_url = blob['mediaLink']
    photo_type = blob['contentType']
    photo_created_on = blob['timeCreated']
